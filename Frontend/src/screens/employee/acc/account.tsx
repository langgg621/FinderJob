...
const AccEmployee =()=>{
    ...
    return (
        ...
        <View style={styles.container}>
            <TouchableOpacity style={[styles.btn, styles.whiteBtn]} onPress={()=>{ navigation.navigate(NAVIGATION_TITLE.CHANGE_PASS_EMP)}}>
            ...
            <TouchableOpacity style={[styles.btn, styles.whiteBtn]} onPress={()=>{ navigation.navigate(NAVIGATION_TITLE.INFO_EMP)}}>
