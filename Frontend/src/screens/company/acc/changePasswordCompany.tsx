...
import { resetCompanyPasswordAction } from "../../../actions/companyActions";
import { NAVIGATION_TITLE } from "../../../constants/navigation";
import { Modal, SafeAreaView, StatusBar, TouchableOpacity, View , StyleSheet , Text , TextInput, ToastAndroid, KeyboardAvoidingView} from "react-native";
...
const ChangePasswordCompany =() =>{
    ...
    const handleResetPassword = async() => {
        if(!password.prePassword || !password.password || !password.rePassword){
            ...
            dispatch(resetCompanyPasswordAction({
